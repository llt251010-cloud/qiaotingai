...
const toolDetails = {
  metal: {
    title: "金属精修",
    desc: "强化不锈钢、铝合金、镀铬、拉丝金属等材质的边缘、高光、反射和质感，清理划痕、灰尘、脏污和杂色。",
    scene: "五金工具、厨具、小家电、数码外壳、金属配件。",
    upload: "建议上传主体清晰、反光不过曝的产品图，保留完整轮廓。",
    cost: "每张约 12 能量点"
  },
  glass: {
    title: "玻璃精修",
    desc: "优化透明、半透明、磨砂玻璃和亚克力材质的通透感、折射、边缘轮廓和自然反光。",
    scene: "玻璃杯、香水瓶、灯具、展示盒、透明包装。",
    upload: "建议上传背景干净、产品边缘完整的图片，避免强眩光遮挡主体。",
    cost: "每张约 12 能量点"
  },
  plastic: {
    title: "塑料精修",
  ...
  apparel: {
    title: "服装精修",
    desc: "整理褶皱、版型、布料纹理、线头、色差和细节层次，保留服装真实面料质感。",
    scene: "服装上新、跨境店铺、模特图、平铺图、详情页展示。",
    upload: "建议上传正面服装图或模特穿搭图，纹理和版型越清晰效果越稳定。",
    cost: "每张约 12 能量点"
  },
  leather: {
    title: "皮革精修",
