export default async function handler(req, res) {
  ...
  const apparelRetouchPrompt = [
    "这是服装图片精修，不是重新设计衣服。必须严格保留原衣服款式、颜色、图案、领口、袖口、纽扣、口袋、下摆、长度和整体轮廓。",
    "重点处理衣服表面的褶皱、皱巴、压痕和凌乱布面，让面料变得平整顺滑、自然舒展，达到熨烫级平整效果。",
    "袖子必须自然挺直和平整，不要卷袖，不要挽袖，不要折叠袖口，不要改变袖长和袖型。",
    "只做清洁、熨平、去皱、去线头、去起球、去污渍、优化光影和面料质感，不要改变服装结构。",
    "不要生成模特、衣架、人台、场景道具、阴影背景或任何新物体。",
    "浜у搧绮句慨锛屽晢涓氬钩閾烘憚褰遍鏍硷紝绾櫧鑳屾櫙锛屾瑙嗗钩瑙嗗浘锛?D 楂樻竻娓叉煋锛岀簿鍑嗚繕鍘熻壊褰╀笌闈㈡枡鏉愯川銆?,
    "涓板瘜鐨勯潰鏂欑汗鐞嗙粏鑺傦紝鍘婚櫎澶氫綑鐨勮ざ鐨憋紝琚栧瓙鑷劧鎸虹洿銆?,
    "璁╄。鏈嶈疆寤撴洿鎸烘嫭骞虫暣锛岀増鍨嬬湅璧锋潵鑸掗€傘€?,
    "淇绾垮ご銆佽ざ鐨便€佽捣鐞冦€佹薄娓嶏紝鍘婚櫎鐢熺‖闃村奖涓庡弽鍏夈€?,
    "鍛堢幇鏌旇蒋椤烘粦闈㈡枡璐ㄦ劅锛屽瀭鍧犺嚜鐒躲€佺汗鐞嗘竻鏅般€?,
    "浼樺寲鍏夊奖绔嬩綋鎰燂紝寮哄寲甯冩枡灞傛锛岀鍚堢數鍟嗕富鍥炬爣鍑嗐€?,
    "涓ユ牸淇濈暀鍘熸湇瑁呮寮忋€侀鑹层€佸浘妗堛€佺増鍨嬬粨鏋勩€侀鍙ｃ€佽鍙ｃ€佺航鎵ｃ€佹媺閾惧拰鏉愯川鐗瑰緛锛屼笉鏀瑰彉浜у搧璁捐銆?,
    "缁濆绂佹鏂板浠讳綍鏂囧瓧銆佷腑鏂囥€佽嫳鏂囥€佹爣棰樸€佽鏄庢枃妗堛€佹爣绛俱€佹暟瀛椼€佸浘鏍囥€乴ogo銆佹按鍗般€佸墠鍚庡姣旀帓鐗堛€佹ā鐗规垨鍦烘櫙閬撳叿銆?,
    "鏈€缁堢敾闈㈠彧鑳藉寘鍚師鏈嶈浜у搧鍜岀函鐧借儗鏅€?,
    `鍥剧墖绫诲瀷锛?{imageType}`,
    `浜у搧鍚嶇О锛?{cleanProduct}`,
    `琛ュ厖瑕佹眰锛?{cleanPoints || "鏈嶈浜у搧绮句慨锛屼繚鎸佺湡瀹炴寮忓拰闈㈡枡璐ㄦ劅"}`,
    `鐢诲箙姣斾緥锛?{ratio}`,
  ].join("\n");
