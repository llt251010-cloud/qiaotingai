export default async function handler(req, res) {
  ...
  const apparelRetouchPrompt = [
    "服装强力平整熨烫精修，商业平铺摄影风格，纯白背景，正视平视图，输出 1600x1600 正方形图片。",
    "这是服装图片精修，不是重新设计衣服。严格保留原衣服款式、颜色、图案、领口、袖口、纽扣、口袋、下摆、长度和整体轮廓。",
    "强力去除衣服表面的褶皱、皱巴、压痕、凌乱布面、线头、起球、污渍和脏点，让面料像熨烫后一样平整顺滑、自然舒展。",
    "袖子必须自然挺直和平整，不要卷袖，不要挽袖，不要折叠袖口，不要改变袖长和袖型。",
    "衣身轮廓要更挺括、更平整，版型舒适自然，但不能改变原有服装结构。",
    "必须保留面料纹理、织物颗粒、缝线、走线、纽扣、口袋细节和真实布料质感，不要磨皮成塑料感。",
    "精准还原服装原本色彩，优化光影立体感，弱化生硬阴影和反光，强化布料层次，符合电商主图标准。",
    "不要生成模特、衣架、人台、场景道具、阴影背景或任何新物体。",
    "绝对禁止新增任何文字、中文、英文、标题、说明文案、标签、数字、图标、logo、水印、前后对比排版。",
    "最终画面只能包含原服装产品和纯白背景。",
    `图片类型：${imageType}`,
    `产品名称：${cleanProduct}`,
    `补充要求：${cleanPoints || "强力服装去皱熨平精修，保留真实款式和面料纹理"}`,
    "输出尺寸：1600x1600",
  ].join("\n");
